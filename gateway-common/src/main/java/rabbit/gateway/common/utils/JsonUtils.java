...
public class JsonUtils {
    ...
    public static JavaType constructMapType(Class<? extends Map> clz, Class<?> key, Class<?> value) {
        return inst.getMapper().getTypeFactory().constructMapType(clz, key, value);
    }
